    ...
    <html lang="zh-CN">
      <body>
        <nav className="bg-white shadow-sm border-b sticky top-0 z-10">
            <Link href="/forum" className="ml-4 text-sm font-medium text-gray-700 hover:text-blue-600">Forum</Link>
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/" className="flex items-center space-x-2">
                <img src="/logo.png" alt="OpenClaw Logo" className="h-8 w-auto" />
                <span className="text-xl font-bold text-blue-600 hover:text-blue-700">OpenClaw 7 Days</span>
              </Link>
