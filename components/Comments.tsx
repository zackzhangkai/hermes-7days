...
const ISSUE_TITLES: Record<string, string> = {
  // Hermes lessons
  'lesson1-intro': 'Lesson 1: Hermes 基础',
  'lesson2-provider': 'Lesson 2: Provider 配置',
  'lesson3-memory': 'Lesson 3: Memory 持久化',
  'lesson4-channel': 'Lesson 4: Channel 配置',
  'lesson5-skill': 'Lesson 5: Skill 系统',
  'lesson6-gateway': 'Lesson 6: Gateway API',
  'lesson7-cron': 'Lesson 7: Cron 定时任务',
  'lesson8-deployment': 'Lesson 8: 生产部署',
}
...
export default function Comments({ courseSlug, courseTitle }: CommentsProps) {
    ...
    async function fetchIssues() {
      ...
      try {
        ...
        const response = await fetch(
          `https://api.github.com/repos/zackzhangkai/hermes-7days/issues?state=all&per_page=10`,
          {
            headers: {
  ...
  const handleComment = () => {
    const repo = 'zackzhangkai/hermes-7days'
